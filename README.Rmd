...
Vamos criar o filtro para os pontos pertencentes ao polígono do Brasil e demais regições.
...
oco2_br %>% 
  ...
  ggplot2::theme_bw()
```
A tendência de aumento da concentração ao longo do tempo é muito semelhante para todos as regiões. Noteriamente a região Norte apresente uma menor sazonalidade com as menores variações da concnetração de CO2 atmosférico do que aquela comparada às demais regiões.
