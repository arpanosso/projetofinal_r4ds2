...
O código abaixo será utilizado para fzer o download dos arquivos CSV com os dados do satélite OCO2. O volume dos dados á alto, aro redor de 11 $GB$.
...
Imagem de dos arquivos baixados.
