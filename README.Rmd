...
O volume dos dados é alto, ao redor de *11 GB*, então para garantir a reprodutibilidade desse material, vamos realizar uma faxina prévia dos dados, retirando os valores perdidos (falhas do sensor) que forão registrados como **-999999.0**, como apresentado abaixo.
